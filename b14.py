...
if __name__ == '__main__':
    try:
        while True:
            print("Убывание чисел. Для остановки работы программы нажмите ctrl+z+Enter или ctrl+c")
            ...
            if n <= 0:
                ...
                continue
            numbers, res = function.num_down(n, bot, top) # возврат кортежа из функции
            print('\nСписок ваших сгенерированных чисел в промежутке от [{};{}] : {}'.format(bot, top, numbers))
            print("Убывание чисел : ", res)
            print('')
